...
if(process.env.DATABASE_URL != undefined) {
    ...
    connectionString = 'postgres://localhost:5432/db_assign_node_form';
}
...
app.post('/nukeID', function(req, res) {
    var delID = req.body.removeID;

    console.log("gonna nuke", delID);

    pg.connect(connectionString, function(err, client, done) {
        client.query("DELETE FROM  people WHERE id = $1", [delID],
